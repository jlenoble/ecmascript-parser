...
var ruleNames =  [ "file", "eos", "expression_In", "identifierReference", 
                   ...
                   "reservedWord", "keyword", "futureReservedWord", "identifierName" ];
...
ECMAScriptPassParser.RULE_identifierName = 71;
...
ECMAScriptPassParser.prototype.callExpression = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 38;
    this.enterRecursionRule(localctx, 38, ECMAScriptPassParser.RULE_callExpression, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 292;
...
ECMAScriptPassParser.prototype.identifierName = function() {
    ...
    this.enterRule(localctx, 142, ECMAScriptPassParser.RULE_identifierName);
    try {
        this.state = 601;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
