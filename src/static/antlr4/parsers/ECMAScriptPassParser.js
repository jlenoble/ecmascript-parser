...
ECMAScriptPassParser.RULE_reservedWord = 66;
ECMAScriptPassParser.RULE_keyword = 67;
ECMAScriptPassParser.RULE_futureReservedWord = 68;
...
ECMAScriptPassParser.prototype.file = function() {
    ...
    try {
        ...
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ECMAScriptPassParser.NumericLiteral) | (1 << ECMAScriptPassParser.RegularExpressionLiteral) | (1 << ECMAScriptPassParser.OpenBrace) | (1 << ECMAScriptPassParser.OpenParen) | (1 << ECMAScriptPassParser.OpenBracket) | (1 << ECMAScriptPassParser.SemiColon))) !== 0) || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (ECMAScriptPassParser.NullLiteral - 57)) | (1 << (ECMAScriptPassParser.BooleanLiteral - 57)) | (1 << (ECMAScriptPassParser.Await - 57)) | (1 << (ECMAScriptPassParser.Const - 57)) | (1 << (ECMAScriptPassParser.For - 57)) | (1 << (ECMAScriptPassParser.Function - 57)) | (1 << (ECMAScriptPassParser.Var - 57)))) !== 0) || ((((_la - 92)) & ~0x1f) == 0 && ((1 << (_la - 92)) & ((1 << (ECMAScriptPassParser.Yield - 92)) | (1 << (ECMAScriptPassParser.Let - 92)) | (1 << (ECMAScriptPassParser.StringLiteral - 92)) | (1 << (ECMAScriptPassParser.IdentifierName - 92)))) !== 0)) {
            this.state = 138;
            this.statementList();
        }
...
ECMAScriptPassParser.prototype.reservedWord = function() {
    ...
    this.enterRule(localctx, 132, ECMAScriptPassParser.RULE_reservedWord);
    try {
        this.state = 520;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
ECMAScriptPassParser.prototype.keyword = function() {
    ...
    this.enterRule(localctx, 134, ECMAScriptPassParser.RULE_keyword);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 522;
...
ECMAScriptPassParser.prototype.futureReservedWord = function() {
    ...
    this.enterRule(localctx, 136, ECMAScriptPassParser.RULE_futureReservedWord);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 524;
