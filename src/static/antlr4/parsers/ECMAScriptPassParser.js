...
ECMAScriptPassParser.prototype.file = function() {
    ...
    try {
        ...
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ECMAScriptPassParser.NumericLiteral) | (1 << ECMAScriptPassParser.RegularExpressionLiteral) | (1 << ECMAScriptPassParser.OpenBrace) | (1 << ECMAScriptPassParser.OpenParen) | (1 << ECMAScriptPassParser.OpenBracket) | (1 << ECMAScriptPassParser.SemiColon))) !== 0) || ((((_la - 59)) & ~0x1f) == 0 && ((1 << (_la - 59)) & ((1 << (ECMAScriptPassParser.NullLiteral - 59)) | (1 << (ECMAScriptPassParser.BooleanLiteral - 59)) | (1 << (ECMAScriptPassParser.Await - 59)) | (1 << (ECMAScriptPassParser.Const - 59)) | (1 << (ECMAScriptPassParser.For - 59)) | (1 << (ECMAScriptPassParser.Function - 59)) | (1 << (ECMAScriptPassParser.This - 59)) | (1 << (ECMAScriptPassParser.Var - 59)))) !== 0) || ((((_la - 94)) & ~0x1f) == 0 && ((1 << (_la - 94)) & ((1 << (ECMAScriptPassParser.Yield - 94)) | (1 << (ECMAScriptPassParser.Let - 94)) | (1 << (ECMAScriptPassParser.StringLiteral - 94)) | (1 << (ECMAScriptPassParser.IdentifierName - 94)))) !== 0)) {
            this.state = 142;
            this.statementList();
        }
...
ECMAScriptPassParser.prototype.statementList_Return = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ECMAScriptPassParser.NumericLiteral) | (1 << ECMAScriptPassParser.RegularExpressionLiteral) | (1 << ECMAScriptPassParser.OpenBrace) | (1 << ECMAScriptPassParser.OpenParen) | (1 << ECMAScriptPassParser.OpenBracket))) !== 0) || ((((_la - 59)) & ~0x1f) == 0 && ((1 << (_la - 59)) & ((1 << (ECMAScriptPassParser.NullLiteral - 59)) | (1 << (ECMAScriptPassParser.BooleanLiteral - 59)) | (1 << (ECMAScriptPassParser.Await - 59)) | (1 << (ECMAScriptPassParser.Const - 59)) | (1 << (ECMAScriptPassParser.Function - 59)) | (1 << (ECMAScriptPassParser.This - 59)))) !== 0) || ((((_la - 94)) & ~0x1f) == 0 && ((1 << (_la - 94)) & ((1 << (ECMAScriptPassParser.Yield - 94)) | (1 << (ECMAScriptPassParser.Let - 94)) | (1 << (ECMAScriptPassParser.StringLiteral - 94)) | (1 << (ECMAScriptPassParser.IdentifierName - 94)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
ECMAScriptPassParser.prototype.iterationStatement = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ECMAScriptPassParser.NumericLiteral) | (1 << ECMAScriptPassParser.RegularExpressionLiteral) | (1 << ECMAScriptPassParser.OpenBrace) | (1 << ECMAScriptPassParser.OpenParen) | (1 << ECMAScriptPassParser.OpenBracket))) !== 0) || ((((_la - 59)) & ~0x1f) == 0 && ((1 << (_la - 59)) & ((1 << (ECMAScriptPassParser.NullLiteral - 59)) | (1 << (ECMAScriptPassParser.BooleanLiteral - 59)) | (1 << (ECMAScriptPassParser.Await - 59)) | (1 << (ECMAScriptPassParser.Function - 59)) | (1 << (ECMAScriptPassParser.This - 59)))) !== 0) || ((((_la - 94)) & ~0x1f) == 0 && ((1 << (_la - 94)) & ((1 << (ECMAScriptPassParser.Yield - 94)) | (1 << (ECMAScriptPassParser.StringLiteral - 94)) | (1 << (ECMAScriptPassParser.IdentifierName - 94)))) !== 0)) {
            this.state = 434;
            this.expression_In();
        }
