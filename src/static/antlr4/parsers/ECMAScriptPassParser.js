...
ECMAScriptPassParser.prototype.file = function() {
    ...
    try {
        ...
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ECMAScriptPassParser.NumericLiteral) | (1 << ECMAScriptPassParser.RegularExpressionLiteral) | (1 << ECMAScriptPassParser.OpenBrace) | (1 << ECMAScriptPassParser.OpenParen) | (1 << ECMAScriptPassParser.SemiColon))) !== 0) || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (ECMAScriptPassParser.NullLiteral - 57)) | (1 << (ECMAScriptPassParser.BooleanLiteral - 57)) | (1 << (ECMAScriptPassParser.Await - 57)) | (1 << (ECMAScriptPassParser.Const - 57)) | (1 << (ECMAScriptPassParser.For - 57)) | (1 << (ECMAScriptPassParser.Function - 57)))) !== 0) || ((((_la - 92)) & ~0x1f) == 0 && ((1 << (_la - 92)) & ((1 << (ECMAScriptPassParser.Yield - 92)) | (1 << (ECMAScriptPassParser.Let - 92)) | (1 << (ECMAScriptPassParser.StringLiteral - 92)) | (1 << (ECMAScriptPassParser.IdentifierName - 92)))) !== 0)) {
            this.state = 120;
            this.statementList();
        }
...
ECMAScriptPassParser.prototype.statementList_Return = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ECMAScriptPassParser.NumericLiteral) | (1 << ECMAScriptPassParser.RegularExpressionLiteral) | (1 << ECMAScriptPassParser.OpenBrace) | (1 << ECMAScriptPassParser.OpenParen))) !== 0) || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (ECMAScriptPassParser.NullLiteral - 57)) | (1 << (ECMAScriptPassParser.BooleanLiteral - 57)) | (1 << (ECMAScriptPassParser.Await - 57)) | (1 << (ECMAScriptPassParser.Const - 57)) | (1 << (ECMAScriptPassParser.Function - 57)))) !== 0) || ((((_la - 92)) & ~0x1f) == 0 && ((1 << (_la - 92)) & ((1 << (ECMAScriptPassParser.Yield - 92)) | (1 << (ECMAScriptPassParser.Let - 92)) | (1 << (ECMAScriptPassParser.StringLiteral - 92)) | (1 << (ECMAScriptPassParser.IdentifierName - 92)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
ECMAScriptPassParser.prototype.iterationStatement = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ECMAScriptPassParser.NumericLiteral) | (1 << ECMAScriptPassParser.RegularExpressionLiteral) | (1 << ECMAScriptPassParser.OpenBrace) | (1 << ECMAScriptPassParser.OpenParen))) !== 0) || ((((_la - 57)) & ~0x1f) == 0 && ((1 << (_la - 57)) & ((1 << (ECMAScriptPassParser.NullLiteral - 57)) | (1 << (ECMAScriptPassParser.BooleanLiteral - 57)) | (1 << (ECMAScriptPassParser.Await - 57)) | (1 << (ECMAScriptPassParser.Function - 57)))) !== 0) || ((((_la - 92)) & ~0x1f) == 0 && ((1 << (_la - 92)) & ((1 << (ECMAScriptPassParser.Yield - 92)) | (1 << (ECMAScriptPassParser.StringLiteral - 92)) | (1 << (ECMAScriptPassParser.IdentifierName - 92)))) !== 0)) {
            this.state = 350;
            this.expression_In();
        }
