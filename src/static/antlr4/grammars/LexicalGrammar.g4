...
// Adapted from  unicode-9.0.0/Binary_Property/ID_Start/regex.js - MIT © Mathias Bynens
fragment
UNICODE_ID_START
...
// Adapted from unicode-9.0.0/Binary_Property/ID_Continue/regex.js - MIT © Mathias Bynens
fragment
UNICODE_ID_CONTINUE
...
| AND          | OR
| QUESTIONMARK | COLON
| ASSIGN       | PLUSASSIGN | MINUSASSIGN    | MULTIPLYASSIGN    | MODULOASSIGN
| POWERASSIGN  | LEFTSHIFTARITHMETICASSIGN   | RIGHTSHIFTARITHMETICASSIGN
| RIGHTSHIFTLOGICALASSIGN   | BITANDASSIGN   | BITORASSIGN       | BITXORASSIGN
| FATARROW
;
