...
| assignmentExpression_In OpenBracket
...
| assignmentExpression Power
  assignmentExpression                        # exponentiationExpression
| assignmentExpression multiplicativeOperator
  assignmentExpression                        # multiplicativeExpression
| assignmentExpression additiveOperator
  assignmentExpression                        # additiveExpression
| assignmentExpression shiftOperator
  assignmentExpression                        # shiftExpression
| assignmentExpression relationalOperator
  assignmentExpression                        # relationalExpression
| assignmentExpression In
  assignmentExpression                        # inExpression
| assignmentExpression Instanceof
  assignmentExpression                        # instanceOfExpression
| assignmentExpression equalityOperator
  assignmentExpression                        # equalityExpression
| assignmentExpression BitAnd
  assignmentExpression                        # bitwiseANDExpression
| assignmentExpression BitXor
  assignmentExpression                        # bitwiseXORExpression
| assignmentExpression BitOr
  assignmentExpression                        # bitwiseORExpression
| assignmentExpression And
  assignmentExpression                        # logicalANDExpression
...
| BooleanLiteral                              # boolExpression
| NumericLiteral                              # numExpression
...
| assignmentExpression_In Power
  assignmentExpression_In                     # exponentiationExpression_In
| assignmentExpression_In multiplicativeOperator
  assignmentExpression_In                     # multiplicativeExpression_In
| assignmentExpression_In additiveOperator
  assignmentExpression_In                     # additiveExpression_In
| assignmentExpression_In shiftOperator
  assignmentExpression_In                     # shiftExpression_In
| assignmentExpression_In relationalOperator
  assignmentExpression_In                     # relationalExpression_In
| assignmentExpression_In In
  assignmentExpression_In                     # inExpression_In
| assignmentExpression_In Instanceof
  assignmentExpression_In                     # instanceOfExpression_In
| assignmentExpression_In equalityOperator
  assignmentExpression_In                     # equalityExpression_In
| assignmentExpression_In BitAnd
  assignmentExpression_In                     # bitwiseANDExpression_In
| assignmentExpression_In BitXor
  assignmentExpression_In                     # bitwiseXORExpression_In
| assignmentExpression_In BitOr
  assignmentExpression_In                     # bitwiseORExpression_In
| assignmentExpression_In And
  assignmentExpression_In                     # logicalANDExpression_In
| assignmentExpression_In Or
...
| assignmentExpression_In assignmentOperator
...
| BooleanLiteral                              # boolExpression_In
| NumericLiteral                              # numExpression_In
| StringLiteral                               # stringExpression_In
| arrayLiteral                                # arrayLiteralExpression_In
